...
local function downloadPremadeProfiles(commit)
	...
	local success, response = pcall(function()
		return game:HttpGet('https://api.github.com/repos/notfrontloop252/aerov4/contents/profiles/premade?ref=' .. commit)
	end)
...
if not shared.VapeDeveloper then
	...
	if #commit ~= 40 then
		local ok, res = pcall(function()
			return game:HttpGet('https://api.github.com/repos/notfrontloop252/aerov4/commits/main', true)
		end)
		if ok and res then
