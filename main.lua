...
local LOADER_URL = "https://raw.githubusercontent.com/notfrontloop252/aerov4/main/downloader.lua" 
local _initArgs = ...
	...
	if not isfile(path) then
		...
		for attempt = 1, 3 do
			local suc, result = pcall(function()
				return game:HttpGet('https://raw.githubusercontent.com/notfrontloop252/aerov4/' .. readfile('aerov4/profiles/commit.txt') .. '/' .. select(1, path:gsub('aerov4/', '')), true)
			end)
...
if not shared.VapeIndependent then
	...
	if isfile('aerov4/games/' .. gameFileId .. '.lua') then
		...
		if not shared.VapeDeveloper then
			local suc, res = pcall(function()
				return game:HttpGet('https://raw.githubusercontent.com/notfrontloop252/aerov4/' .. readfile('aerov4/profiles/commit.txt') .. '/games/' .. gameFileId .. '.lua', true)
			end)
